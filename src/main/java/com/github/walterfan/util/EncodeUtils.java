...
public class EncodeUtils {
     ...
     * @throws Exception
     */
    public static String convertEncoding(String input, String fromCharset, String toCharset) throws Exception {
        CharsetEncoder encoder = Charset.forName(fromCharset).newEncoder();
        CharsetDecoder decoder = Charset.forName(toCharset).newDecoder();
